	...
	internal static class DatabaseInitializer
	{
		...
		private static void InsertPositions()
		{
			_context.Positions.AddRange(new List<Position>
			{
				...
				new Position("Грузчик", "Завантажує та розвантажує товари з транспортних засобів, " +
				"розміщює вантажі на складі, пакує та розпаковує товари. Грузчик повинен бути " +
				"фізично витривалим, уважним та відповідальним, здатним ефективно працювати в " +
				"команді та дотримуватися стандартів безпеки під час обробки вантажів."),
