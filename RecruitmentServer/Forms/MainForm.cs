...
namespace RecruitmentServer.Forms
{
	...
	internal partial class MainForm : BaseForm, IThemeChange
	{
		...
		private readonly Dictionary<Guna2GradientButton, FullVacancy> _buttonVacancyMap =
		...
		private void CreateVacancies()
		{
			...
			List<FullVacancy> vacancies = DataBase.GetVacancies(_createdPanels.Count,
		...
		private void CreateApplications()
		{
			...
			List<FullApplication> applications = DataBase.GetApplications(
		...
		private void CreateVacancy(FullVacancy vacancy)
		{
		...
		private void CreateApplication(FullApplication application)
		{
