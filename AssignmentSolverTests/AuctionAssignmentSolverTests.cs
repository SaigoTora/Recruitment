...
namespace AssignmentSolverTests
{
	...
	public class AuctionAssignmentSolverTests
	{
		...
		[TestMethod]
		public void TestAuctionAlgorithm_Scenario2()
		{
			// Arrange
		...
		[TestMethod]
		public void TestAuctionAlgorithm_Scenario3()
		{
			// Arrange
			...
			bool firstCondition = result.SequenceEqual(firstExpect);
			int[] secondExpect = { 2, 3, 1 };
			bool secondCondition = result.SequenceEqual(secondExpect);

			Assert.IsTrue(firstCondition || secondCondition);
		}
		[TestMethod]
		public void TestAuctionAlgorithm_Scenario4()
		{
			// Arrange
		...
		[TestMethod]
		public void TestAuctionAlgorithm_Scenario5()
		{
			// Arrange
		...
		[TestMethod]
		public void TestAuctionAlgorithm_Scenario6()
		{
			// Arrange
			int[,] matrix = new int[3, 4];
			matrix[0, 0] = 2;
